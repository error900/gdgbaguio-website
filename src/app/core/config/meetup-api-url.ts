...
export const meetupApiURL = {
  // GET
  pastEvents: conf.event+'?sign=true&photo-host=public&desc=true&has_ended=true&status=past&only=id,name,local_date,link,description,venue,how_to_find_us&omit=venue.id,venue.lat,venue.lon,venue.repinned,venue.city,venue.country,venue.localized_country_name&no_later_than=',
